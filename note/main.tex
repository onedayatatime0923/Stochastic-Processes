        ...
        \begin{itemize}
            ...
            \item Renewal Process: an arrival process with i.i.d $X_i$
                \begin{itemize}
                    ...
                    \item Property
                        \begin{itemize}
                            \item for any $t, P[N(t) < \infty] = 1$ and $P[\lim_{n \rightarrow \infty} S_n = \infty] = 1$

                                Proof: $\lim_{n \rightarrow \infty} P[S_n = \infty] = \lim_{n \rightarrow \infty} P[\sum_{i = 1}^n X_n = n \times \mathbb{E}[X_i]] = 1$
                            \item $\lim_{t \rightarrow \infty} N(t) \rightarrow \infty$

                                Proof: if $\lim_{t \rightarrow \infty} N(t) = k \rightarrow X_{k+1} = \infty$ and $P[X_{k+1}] = \infty] = 0$
                        \end{itemize}
                \end{itemize}
    ...
    \begin{itemize}
        ...
        \item $Y(t)$: number of cutomers in the service
            \begin{itemize}
                ...
                \item Consider $Y(t)$ is a splitting Poisson Process with probability $(\frac{1}{t}\int_0^t P[T > x] dx)$ to still in the service
                    \begin{itemize}
                        \item the distribution for the arrival given $N(t)$ is universal
                        \item the probability the arrival is still in service $\frac{1}{t} \int_0^t P[T > t-x] dx = \frac{1}{t}\int_0^t P[T > x] dx$
                    \end{itemize}
            \end{itemize}
    \end{itemize}
\end{itemize}
